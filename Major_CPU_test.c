			...
			for (i = 1; i < (NX - 1); i++) {
				if (h_body[i + j*NX + k*NX*NY] != 0.0) {
					...
					if (!h_body[(i - 1) + j*NX + k*NX*NY]) {
                                                        ...
                                                        FB[i + j*NX + k*NX*NY + 2*N] = F[i + j*NX + k*NX*NY + 2*N] + (-2)*speed*U[i + j*NX + k*NX*NY + 2*N];
                                                        ...
                                                        FF[i + j*NX + k*NX*NY + 2*N] = F[i + j*NX + k*NX*NY + 2*N] + 2*speed*U[i + j*NX + k*NX*NY + 2*N];
                                                        ...
                                                        FD[i + j*NX + k*NX*NY + 3*N] = G[i + j*NX + k*NX*NY + 3*N] + (-2)*speed*U[i + j*NX + k*NX*NY + 3*N];
                                                        ...
                                                        FU[i + j*NX + k*NX*NY + 3*N] = G[i + j*NX + k*NX*NY + 3*N] + 2*speed*U[i + j*NX + k*NX*NY + 3*N];
